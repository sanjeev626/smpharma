...
echo "here";exit;
        //$this->ion_auth->register($username, $password, $email, $additional_data, $group)
          $this->ion_auth->register('ayazdin', '12345678', 'ayaz.din@gmail.com', array( 'first_name' => 'Ayaz', 'last_name' => 'Uddin' ), array('1') );
      }
...
//echo "here we are";exit;		
	...
	function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
            ...
            $this->data['main'] = 'core/change_password';
           // $this->data['allmodules'] = $this->general_model->get_all_modules();
