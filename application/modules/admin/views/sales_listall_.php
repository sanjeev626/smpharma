                ...
                if (!empty($medicine_info)) { 
                  ...
                  <tr>
                    ...
                    <td class="table-action text-center">
                      <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>admin/Medicine/edit/<?php echo $row->id; ?>"><i class="fa fa-edit tooltips" data-original-title="Edit Activity"></i> Edit</a>
                      |
                      <button type="button" class="btn btn-success btn-sm delete_Activity" link="<?php echo base_url(); ?>admin/Medicine/deleteMedicine/<?php echo $row->id; ?>" data-toggle="modal" data-target="#myModalDelete"><i class="fa fa-trash tooltips" data-original-title="Delete Activity"></i> Delete</button>
                    </td>
                  </tr>
                  <?php
                  $i++;
