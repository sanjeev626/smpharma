...
<script type="text/javascript">
  ...
  function calculate_grandtotal()
  {
    ...
    //$("#total_amount").val(parseFloat(Math.round(gtotal* 100) / 100).toFixed(2));
    //$(".result").val(total);

    /*var gtotal = 0;    
    $('.sub_total').each(function () {
        val = parseFloat($(this).val()) | 0;
        gtotal = val ? (parseFloat(gtotal + val)) : gtotal;
    });*/
    //$("#total_amount").val(parseFloat(Math.round(gtotal* 100) / 100).toFixed(2));
    //alert('hello');
    //var myTotal=0;              
    ...
    //$('#discount_percentage').val(myTotal);
...
<div class="box box-info">
    ...
    <div class="panel-body panel-body-nopadding">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-8">
            <input type="text" required name="discount_percentage" id='discount_percentage' class="form-control" value='' onkeyup="calculate_grandtotal();" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">Discount :<span class="asterisk">*</span></label>
          <div class="col-sm-8">
            <input type="text" required name="discount_amount" id='discount_amount' class="form-control" value='' onkeyup="calculate_grandtotal();" />
          </div>
        </div>
        <div class="form-group">
          <label class="col-sm-2 control-label">Grand Total :<span class="asterisk">*</span></label>
          <div class="col-sm-8">
              <input type="text" required readonly name="grand_amount" id='grand_amount' class="form-control" value='' />
          </div>
        </div>
        <div class="form-group">
