...
class medicine_model extends CI_Model {
    ...
    function get_medicine_info($medicine_id){
        $this->db->select('tbl_medicine.medicine_name,tbl_stock.stock,tbl_stock.sales,tbl_stock.cp_per_unit,tbl_stock.sp_per_unit,tbl_stock.quantity,tbl_stock.deal,tbl_stock.rate,tbl_stock.deal_percentage,tbl_stock.stock,tbl_stock.sales,tbl_supplier.fullname,tbl_supplier.address,tbl_supplier.landline,tbl_supplier.mobile,tbl_creditmemo.invoice_nepali_date,tbl_creditmemo.invoice_no,tbl_creditmemo.total_amount,tbl_creditmemo.discount_amount');
